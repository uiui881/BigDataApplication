...
<table style="text-align:center; margin-left:auto; margin-right:auto">
        ...
        <tr><td colspan="3"><h2>Staff Service</h2></td></tr>
        <tr><td><select name="age1" id="age1">
...
<tr><td colspan="3">
        <?php
        if (empty($_POST['age1']) || empty($_POST['sex1'])){}
        else{
          $drop_age = $_POST['age1'];
          $drop_sex = $_POST['sex1'];
          if($drop_age =="10s"){
            if($drop_sex=="female"){
              $sql = "  SELECT brand.brand_name, AVG(rate.staff_service) as avg, DENSE_RANK() OVER (ORDER BY avg DESC) AS rank
              ...
              ORDER BY AVG(rate.staff_service) DESC;";
