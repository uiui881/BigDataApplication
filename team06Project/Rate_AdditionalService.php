...
<table style="text-align:center; margin-left:auto; margin-right:auto">
      ...
      <tr><td colspan="3"><h2>Additional Service</h2></td></tr>
      <tr><td><select name="age5" id="age5">
      ...
      if (empty($_POST['age5']) || empty($_POST['sex5'])){}
      else{
        $drop_age = $_POST['age5'];
        $drop_sex = $_POST['sex5'];
        if($drop_age =="10s"){
          if($drop_sex=="female"){
            $sql = "  SELECT brand.brand_name, AVG(rate.additional_service) as avg, DENSE_RANK() OVER (ORDER BY avg DESC) AS rank
            ...
            ORDER BY AVG(rate.additional_service) DESC;";
