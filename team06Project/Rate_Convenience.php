...
<table style="text-align:center; margin-left:auto; margin-right:auto">
        ...
        <tr><td colspan="3"><h2>Convenience</h2></td></tr>
        <tr><td>
      ...
      if (empty($_POST['age3']) || empty($_POST['sex3'])){}
      else{
        $drop_age = $_POST['age3'];
        $drop_sex = $_POST['sex3'];
        if($drop_age =="10s"){
          if($drop_sex=="female"){
            $sql = "  SELECT brand.brand_name, AVG(rate.convenience) as avg, DENSE_RANK() OVER (ORDER BY avg DESC) AS rank
            ...
            ORDER BY AVG(rate.convenience) DESC;";
