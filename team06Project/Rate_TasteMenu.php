...
<table style="text-align:center; margin-left:auto; margin-right:auto">
        ...
        <tr><td colspan="3"><h2>Taste&Menu</h2></td></tr>
        <tr><td>
          <select name="age4" id="age4">
      ...
      if (empty($_POST['age4']) || empty($_POST['sex4'])){
        ...
        if($drop_age =="10s"){
          if($drop_sex=="female"){
            $sql = "  SELECT brand.brand_name, AVG(rate.taste_menu) as avg, DENSE_RANK() OVER (ORDER BY avg DESC) AS rank
            ...
            ORDER BY AVG(rate.taste_menu) DESC;";
